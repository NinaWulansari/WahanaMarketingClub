        ...
        if (attrs != null) {
            ...
            if (typedArray != null) {
                try {
                    ...
                    if (typedArray.hasValue(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarTextColor)) {
                        mIndexbarTextColor = Color.parseColor(typedArray.getString(R.styleable.IndexFastScrollRecyclerView_setIndexBarTextColor));
                    }

                    if (typedArray.hasValue(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarHighlightTextColor)) {
                    ...
                    if (typedArray.hasValue(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarColorRes)) {
                        mIndexbarBackgroudColor = typedArray.getColor(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarColorRes, mIndexbarBackgroudColor);
                    }

                    if (typedArray.hasValue(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarTextColorRes)) {
                        mIndexbarTextColor = typedArray.getColor(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarTextColorRes, mIndexbarTextColor);
                    }

                    if (typedArray.hasValue(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarHighlightTextColorRes)) {
                        mIndexbarHighLateTextColor = typedArray.getColor(com.wahana.wahanamarketingclub.R.styleable.IndexFastScrollRecyclerView_setIndexBarHighlightTextColor, mIndexbarHighLateTextColor);
                    }
